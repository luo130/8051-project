      ...
      000003 02 00 86         [24]  347 	ljmp	_main
                                    ...
                                    359 ;------------------------------------------------------------
                                    360 ;	main.c:4: void delay_ms(unsigned int ms) {
                                    361 ;	-----------------------------------------
      ...
      00006F 50 14            [24]  384 	jnc	00109$
                                    385 ;	main.c:7: for (j = 0; j < 110; j++);
      000071 7A 6E            [12]  386 	mov	r2,#0x6e
      000073 7B 00            [12]  387 	mov	r3,#0x00
      000075                        388 00105$:
      000075 1A               [12]  389 	dec	r2
      000076 BA FF 01         [24]  390 	cjne	r2,#0xff,00130$
      000079 1B               [12]  391 	dec	r3
      00007A                        392 00130$:
      00007A EA               [12]  393 	mov	a,r2
      00007B 4B               [12]  394 	orl	a,r3
      00007C 70 F7            [24]  395 	jnz	00105$
                                    396 ;	main.c:6: for (i = 0; i < ms; i++)
      00007E 0C               [12]  397 	inc	r4
      00007F BC 00 E8         [24]  398 	cjne	r4,#0x00,00107$
      000082 0D               [12]  399 	inc	r5
      000083 80 E5            [24]  400 	sjmp	00107$
      000085                        401 00109$:
                                    402 ;	main.c:8: }
      000085 22               [24]  403 	ret
                                    404 ;------------------------------------------------------------
                                    405 ;Allocation info for local variables in function 'main'
                                    406 ;------------------------------------------------------------
                                    407 ;	main.c:10: void main() {
                                    408 ;	-----------------------------------------
                                    409 ;	 function main
                                    410 ;	-----------------------------------------
      000086                        411 _main:
                                    412 ;	main.c:11: while (1) {
      000086                        413 00102$:
                                    414 ;	main.c:12: P1_0 = 0;   // ← 直接使用 P1_0（SDCC 自带定义）
                                    415 ;	assignBit
      000086 C2 90            [12]  416 	clr	_P1_0
                                    417 ;	main.c:13: delay_ms(500);
      000088 90 01 F4         [24]  418 	mov	dptr,#0x01f4
      00008B 12 00 62         [24]  419 	lcall	_delay_ms
                                    420 ;	main.c:14: P1_0 = 1;
                                    421 ;	assignBit
      00008E D2 90            [12]  422 	setb	_P1_0
                                    423 ;	main.c:15: delay_ms(500);
      000090 90 01 F4         [24]  424 	mov	dptr,#0x01f4
      000093 12 00 62         [24]  425 	lcall	_delay_ms
                                    426 ;	main.c:17: }
      000096 80 EE            [24]  427 	sjmp	00102$
                                    428 	.area CSEG    (CODE)
                                    429 	.area CONST   (CODE)
                                    430 	.area XINIT   (CODE)
